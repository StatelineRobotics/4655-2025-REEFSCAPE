...
public class Hopper extends SubsystemBase {
    ...
    private static final pivotAllowedError = 1.0;
    private static final intakeAngle = 0.0;
    private static final climbAngle = 100.0;
    
    private static final intakeBeltVoltage = 6.0;
    ...
    public Command intakeCommand() {
        return (run(() -> requestPivotAngle(intakeAngle)).until(pivotAtSetpoint).withName("Pivot To Intake"))
                .andThen(runEnd(() -> (intakeBeltVoltage), this::stopBelt).withName("Run Belt Intake")).withName("Inake Sequence");
    }
