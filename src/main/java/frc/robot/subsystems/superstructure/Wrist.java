...
public class Wrist extends SubsystemBase {
  ...
  private void reqestIntakeVoltage(double voltage) {
  ...
  public Command upperTestCommand() {
    return this.defer(
        () ->
            Commands.runOnce(
                () -> requestWristPosition(SmartDashboard.getNumber("Wrist/upperSetpoint", 0.0))));
  }
  ...
  public Command lowerTestCommand() {
    return this.defer(
        () ->
            Commands.runOnce(
                () -> requestWristPosition(SmartDashboard.getNumber("Wrist/lowerSetpoint", 0.0))));
  }
